    ...
    public boolean visit(JpqlSubselect node, InMemoryEvaluationParameters data) {
        ...
        try {
            ...
            for (Replacement replacement: replacements) {
                ...
                Collection<?> resultCollection = getResultCollection(result);
            ...
            for (Iterator<Map<Alias, Object>> i
                     = new ValueIterator(aliasValues, subselect.getTypeDefinitions(), pathEvaluator);
                 i.hasNext();) {
