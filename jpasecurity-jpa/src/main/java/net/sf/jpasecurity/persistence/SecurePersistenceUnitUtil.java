...
public class SecurePersistenceUnitUtil implements PersistenceUnitUtil {
    ...
    public SecurePersistenceUnitUtil(SecureObjectLoader secureObjectLoader) {
        ...
        objectLoader = secureObjectLoader;
    }

    public Object getIdentifier(Object entity) {
        return objectLoader.getIdentifier(entity);
    }

    public boolean isLoaded(Object entity) {
        return objectLoader.isLoaded(entity);
    }

    public boolean isLoaded(Object entity, String property) {
        return objectLoader.isLoaded(entity, property);
    }
}
