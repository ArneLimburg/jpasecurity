...
public class ToStringVisitorTest extends TestCase {
	...
	public void testToStringVisitor() throws ParseException {
        ...
        assertJpql("SELECT bean FROM TestBean bean INNER JOIN bean.parent parent WITH parent.name = 'Parent' WHERE bean.id = :id");
        ...
        assertJpql("SELECT bean FROM TestBean bean WHERE NOT EXISTS ( SELECT bean FROM TestBean bean WHERE bean.id = :id)");
